...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 311680,
    DYNAMIC_BASE = 5554560,
    DYNAMICTOP_PTR = 311504;
...
// {{PRE_LIBRARY}}
  ...
  /** @type {function(...*):?} */
  function __Z21parse_descriptor_areaPhjP14ES_STREAM_INFO(
  ) {
  err('missing function: _Z21parse_descriptor_areaPhjP14ES_STREAM_INFO'); abort(-1);
  }
  ...
  var ___tm_current=311520;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 311568, 4), 311568);
