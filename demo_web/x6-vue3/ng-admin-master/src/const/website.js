export default {
  ...
  info: {
    title: 'ng-admin',
    list: [
      'ng-admin 是一个基于XXXX工程可视化管理平台，采用token交互验证方式。',
      '您可以 ng-admin 为基础，不只限制于vue的页面，你可以嵌入任意第三方网站，基于iframe框架。',
      'ng-admin 构建简单上手快，最大程度上帮助企业节省时间成本和费用开支。'
    ]
  },
  wel: {
    title: 'ng-admin 通用管理系统快速开发框架',
    list: [
