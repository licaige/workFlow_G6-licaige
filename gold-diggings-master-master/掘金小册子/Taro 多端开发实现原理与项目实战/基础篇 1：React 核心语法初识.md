...
需要说明的是，由于微信小程序的限制，React 中某些写法和特性在 Taro 中还未能实现，后续将会逐渐完善。差异的部分可以在[《基础篇 4：Taro 开发说明与注意事项》](https://juejin.im/book/5b73a131f265da28065fb1cd/section/5b74d725e51d45665e39eb98)章节里查看。
